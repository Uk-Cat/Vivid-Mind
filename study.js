...
// No sidebar toggle needed for permanent sidebar
// Event listeners handled in toggleSidebar function if needed on mobile
...
async function startStudySession(setName) {
    try {
        ...
        // Shuffle cards (optional - remove if you want them in order)
